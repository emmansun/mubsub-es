...
class Connection extends EventEmitter {
    ...
    get state() {
        ...
        if (this.destroyed) {
            state = 'destroyed';
        } else if (this.client?.topology?.isConnected()) { // https://github.com/mongodb/node-mongodb-native/blob/d266158c9e968c92e8041211ef99f1783025be40/src/operations/connect.ts#L18
            state = 'connected';
        } else {
            state = 'connecting';
        }
